...
namespace dcp.BootstrapTheme.Models
{
    public class dcpBootstrapThemeSettingsPart : ContentPart
    {
        ...
        {
            get { return this.Retrieve(r => r.NavStyle); }
            set { this.Store(r => r.NavStyle, value); }
        }
