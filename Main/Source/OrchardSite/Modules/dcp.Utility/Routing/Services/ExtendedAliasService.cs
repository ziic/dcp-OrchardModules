...
namespace dcp.Utility.Routing.Services
{
    ...
    public class ExtendedAliasService : IExtendedAliasService
    {
        ...
        public ExtendedAliasService(IAliasStorage aliasStorage, IRepository<ExtendedAliasRecord> repository, IRepository<AliasRecord> aliasRepository)
        {
