...
using dcp.Routing.Redirects.Models;
using dcp.Routing.Redirects.Services;
using Orchard;
...
namespace dcp.Routing.Redirects.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(IRoutingAppService routingAppService, IOrchardServices orchardServices, ISiteService siteService, IWebConfigService webConfigService)
        {
